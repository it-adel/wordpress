<?php
    ...
    if ( ! class_exists( 'ReduxFrameworkInstances' ) ) {
        // Instance Container
        require_once EDUCATITO_OPTION_PATH . 'ReduxCore/inc/class.redux_instances.php';
        require_once EDUCATITO_OPTION_PATH . 'ReduxCore/inc/lib.redux_instances.php';
    }
    ...
    if ( ! class_exists( 'ReduxFramework' ) ) {
        ...
        // Redux CDN class
        require_once EDUCATITO_OPTION_PATH . 'ReduxCore/inc/class.redux_cdn.php';

        // Redux API class  :)
        require_once EDUCATITO_OPTION_PATH . 'ReduxCore/inc/class.redux_api.php';

        // General helper functions
        require_once EDUCATITO_OPTION_PATH . 'ReduxCore/inc/class.redux_helpers.php';

        // General functions
        require_once EDUCATITO_OPTION_PATH . 'ReduxCore/inc/class.redux_functions.php';
        require_once EDUCATITO_OPTION_PATH . 'ReduxCore/inc/class.p.php';

        require_once EDUCATITO_OPTION_PATH . 'ReduxCore/inc/class.thirdparty.fixes.php';

        require_once EDUCATITO_OPTION_PATH . 'ReduxCore/inc/class.redux_filesystem.php';

        require_once EDUCATITO_OPTION_PATH . 'ReduxCore/inc/class.redux_admin_notices.php';

        // ThemeCheck checks
        require_once EDUCATITO_OPTION_PATH . 'ReduxCore/inc/themecheck/class.redux_themecheck.php';

        // Welcome
        require_once EDUCATITO_OPTION_PATH . 'ReduxCore/inc/welcome/welcome.php';
        ...
        class ReduxFramework {
            ...
            private function _tracking() {
                if ( file_exists( EDUCATITO_OPTION_PATH . 'ReduxCore/inc/tracking.php' ) ) {
                    require_once EDUCATITO_OPTION_PATH . 'ReduxCore/inc/tracking.php';
...
//                    }
            ...
            private function _register_extensions() {
                $path    = EDUCATITO_OPTION_PATH . 'ReduxCore/inc/extensions/';
