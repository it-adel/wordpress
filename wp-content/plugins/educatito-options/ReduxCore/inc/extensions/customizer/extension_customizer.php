        ...
        class ReduxFramework_extension_customizer {
            ...
            public function _register_customizer_controls( $wp_customize ) {
                ...
                if ( ! class_exists( 'Redux_Customizer_Section' ) ) {
                    require_once EDUCATITO_OPTION_PATH . 'ReduxCore/inc/extensions/customizer/inc/customizer_section.php';
                    if ( method_exists( $wp_customize, 'register_section_type' ) ) {
                        $wp_customize->register_section_type( 'Redux_Customizer_Section' );
                    }
                }
                if ( ! class_exists( 'Redux_Customizer_Panel' ) ) {
                    require_once EDUCATITO_OPTION_PATH . 'ReduxCore/inc/extensions/customizer/inc/customizer_panel.php';
                ...
                if ( ! class_exists( 'Redux_Customizer_Control' ) ) {
                    require_once EDUCATITO_OPTION_PATH . 'ReduxCore/inc/extensions/customizer/inc/customizer_control.php';
                }

                require_once EDUCATITO_OPTION_PATH . 'ReduxCore/inc/extensions/customizer/inc/customizer_fields.php';
                require_once EDUCATITO_OPTION_PATH . 'ReduxCore/inc/extensions/customizer/inc/customizer_devs.php';
