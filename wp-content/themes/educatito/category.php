...
$edu_content = 'uk-width-large-1-1 uk-width-medium-1-1 uk-width-small-1-1 uk-width-1-1 educatito-content category-content';
$sidebar_display = '';
if (is_active_sidebar('educatito_sidebar_archive') && ($educatito_options['jrb_sidebar_archive'] != 'no_sidebar' )) {
    $edu_content = 'uk-width-large-3-4 uk-width-medium-1-1 uk-width-small-1-1 uk-width-1-1 educatito-content category-content ';
...
?>
<div class="uk-container uk-container-center educatito_layout_content post-list blog-v2 latest-post">
