        ...
        <?php foreach ($items as $item) { ?>
            ...
            <li class="<?php echo join(' ', $item->get_class()); ?>">
                ...
                if ($item->is_visible()) {
                    ...
                    ?>
                    <div class="index"><?php echo '<span class="label">' . esc_html__('Lecture ', 'educatito') . '</span>' . $index; ?></div>
                    <?php
...
<?php } else { ?>
    ...
    <?php learn_press_display_message(esc_html__('No items in this section', 'educatito')); ?>
